...
def get_args():
    ...
    parser.add_argument('--render', default='human', type=bool, help='renders the atari environment')
...
def train(shared_model, shared_optimizer, rank, args, info):
    ...
    while info['frames'][0] <= 8e4 or args.test:
        ...
        for i in reversed(range(len(rewards))):
            ...
            policy_loss = policy_loss - \
                logps[i] * Variable(gae) - 0.01 * entropies[i]
